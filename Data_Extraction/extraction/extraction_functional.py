...
def extracted_data():
    ...
    db_name = "/Users/xuyingwangswift/Desktop/ETL_Pipelines/data/news.db"
    table_name = "news"
    ...
    df_table = source_data_from_table(db_name, table_name)
    df_csv = source_data_from_csv(csv_file_name)
    df_api = source_data_from_api(api_endpoint)
    df_web_page = source_data_from_webpage(web_page_url, matching_keyword)
    return df_parquet, df_table, df_csv, df_api, df_web_page
